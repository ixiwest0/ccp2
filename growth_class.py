...
OUTPUT_BASE_DIR = "../Desktop/생육데이터2"
...
leaf_length = GrowthDataAnalysis(input_file= input_file_name, mode="옆장(cm)", output_dir= os.path.join(OUTPUT_BASE_DIR, "개체 별 엽장"))
...
leaf_width = GrowthDataAnalysis(input_file= input_file_name, mode = "옆폭(cm)", output_dir= os.path.join(OUTPUT_BASE_DIR, "개체 별 엽폭"))
